...
class ModuleIOTalonFX : public ModuleIO {
 public:
  ModuleIOTalonFX(const std::string_view name, const std::string_view canBus,
                  const int driveId, const int turnId, const int encoderId,
                  const double encoderOffset, const double turnReduction);
 ...
 private:
  ...
  TalonFXCurrentConfigurator driveCurrentConfigurator;
