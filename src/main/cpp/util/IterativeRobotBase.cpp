...
IterativeRobotBase::IterativeRobotBase(units::second_t period,
    ...
    : m_period(period),
      m_watchdog(watchdogPeriod, [this] { PrintLoopOverrunMessage(); }) {}
...
units::second_t IterativeRobotBase::GetPeriod() const { return m_period; }
...
void IterativeRobotBase::PrintWatchdogEpochs() { m_watchdog.PrintEpochs(); }
